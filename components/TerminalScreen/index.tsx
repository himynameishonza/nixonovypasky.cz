    ...
    return (
        <div className="w-full h-full bg-black font-terminal overflow-hidden relative">
            <div className="fixed border-4 md:border-8 border-x-neutral-900 border-y-neutral-800 rounded-3xl p-0 top-4 left-4 bottom-4 right-4 md:top-8 md:left-8 md:right-8 md:bottom-8 opacity-50 overflow-hidden z-30">
                ...
                <div className="absolute bg-amber-900 bg-opacity-20 top-2 left-2 right-2 bottom-2 md:top-4 md:left-4 md:right-4 md:bottom-4 rounded-2xl md:rounded-md overflow-hidden z-0 animate-pulse-terminal">
                    {children}
                </div>
            </div>
        </div>
